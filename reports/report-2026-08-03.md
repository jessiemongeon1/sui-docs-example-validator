...
```
✓ Lockfile passes supply-chain policies (verified 589ms ago)
[ERR_PNPM_OUTDATED_LOCKFILE] Cannot install with "frozen-lockfile" because pnpm-lock.yaml is not up to date with <ROOT>/package.json
...
| 7 | examples/oracle-adapter/move | move | MystenLabs/sui (internal) | PASS | 11.0s | 3 |
| 8 | examples/oracle-adapter/ts | typescript | MystenLabs/sui (internal) | PASS | 13.6s | 5 |
| 9 | examples/vesting | move | MystenLabs/sui (internal) | PASS | 0.5s | 6 |
| 10 | examples/move/coin | move | MystenLabs/sui (internal) | PASS | 0.5s | 5 |
| 11 | examples/regulated-coin/move | move | MystenLabs/sui (internal) | PASS | 0.4s | 1 |
| 12 | examples/regulated-coin/ts-client | typescript | MystenLabs/sui (internal) | **FAIL** | 0.9s | 1 |
| 13 | examples/move/nft-soulbound | move | MystenLabs/sui (internal) | PASS | 0.4s | 1 |
| 14 | examples/move/nft-rental | move | MystenLabs/sui (internal) | PASS | 6.1s | 1 |
| 15 | examples/move/token | move | MystenLabs/sui (internal) | PASS | 0.5s | 1 |
| 16 | examples/trading/contracts/escrow | move | MystenLabs/sui (internal) | PASS | 0.5s | 3 |
| 17 | examples/deepbook-spot | typescript | MystenLabs/sui (internal) | PASS | 2.0s | 13 |
| 18 | examples/deepbook-margin | typescript | MystenLabs/sui (internal) | PASS | 2.1s | 11 |
| 19 | examples/deepbook-predict | typescript | MystenLabs/sui (internal) | PASS | 2.1s | 9 |
| 20 | examples/ptb-cookbook | typescript | MystenLabs/sui (internal) | PASS | 2.1s | 6 |
| 21 | examples/move/color_object | move | MystenLabs/sui (internal) | PASS | 0.4s | 1 |
| 22 | MystenLabs/sagat@main/api | typescript | MystenLabs/sagat@main | PASS | 2.8s | 4 |
| 23 | MystenLabs/sui-move-bootcamp@solution/K2/src | typescript | .../sui-move-bootcamp@solution | **FAIL** | 2.8s | 5 |
| 24 | MystenLabs/sui-move-bootcamp@solution/K2 | typescript | .../sui-move-bootcamp@solution | **FAIL** | 0.5s | 1 |
| 25 | MystenLabs/onlyfins-example-app@main/frontend | typescript | ...s/onlyfins-example-app@main | PASS | 29.4s | 1 |
| 26 | ...07-Walrus-SDK-upload-relay/hands-on-source-code | typescript | ...Labs/Walrus-Onboarding@main | PASS | 4.1s | 2 |
| 27 | MystenLabs/onlyfins-example-app@main/backend | typescript | ...s/onlyfins-example-app@main | PASS | 4.2s | 3 |
| 28 | MystenLabs/walrus-pocs@main/sdk | typescript | MystenLabs/walrus-pocs@main | PASS | 4.1s | 3 |
| 29 | MystenLabs/Walrus-Onboarding@main/11-Batch-storage | typescript | ...Labs/Walrus-Onboarding@main | PASS | 4.0s | 2 |
| 30 | MystenLabs/onlyfins-example-app@main/frontend/src | typescript | ...s/onlyfins-example-app@main | PASS | 6.8s | 6 |
| 31 | MystenLabs/ts-sdks@main/packages | typescript | MystenLabs/ts-sdks@main | PASS | 14.2s | 1 |
| 32 | MystenLabs/walrus-sites@main/examples | unknown | MystenLabs/walrus-sites@main | PASS | 0.0s | 1 |
| 33 | MystenLabs/messaging-sdk-example@main/frontend/src | typescript | .../messaging-sdk-example@main | PASS | 20.2s | 1 |
| 34 | MystenLabs/onlyfins-example-app@main/frontend/move | move | ...s/onlyfins-example-app@main | PASS | 6.2s | 1 |
| 35 | ...enLabs/sui-move-bootcamp@main/K5/seal-demo/move | move | ...Labs/sui-move-bootcamp@main | PASS | 4.7s | 3 |
| 36 | MystenLabs/walrus-pocs@main/walrus-seal/app/src | typescript | MystenLabs/walrus-pocs@main | PASS | 28.2s | 4 |
| 37 | MystenLabs/sui-move-bootcamp@main/K5/seal-demo/ts | typescript | ...Labs/sui-move-bootcamp@main | PASS | 3.6s | 1 |
| 38 | ...essaging@main/move/packages/sui_stack_messaging | move | ...bs/sui-stack-messaging@main | PASS | 10.6s | 3 |
| 39 | MystenLabs/sui-stack-messaging@main/chat-app/src | typescript | ...bs/sui-stack-messaging@main | PASS | 13.4s | 1 |
| 40 | MystenLabs/ticketing-poc@main/move | move | MystenLabs/ticketing-poc@main | PASS | 0.6s | 3 |
| 41 | MystenLabs/ticketing-poc@main/app/src/app | typescript | MystenLabs/ticketing-poc@main | PASS | 78.0s | 1 |
| 42 | MystenLabs/ticketing-poc@main/app | typescript | MystenLabs/ticketing-poc@main | PASS | 41.5s | 1 |
| 43 | MystenLabs/solitaire@main/move/solitaire | move | MystenLabs/solitaire@main | PASS | 0.6s | 1 |
| 44 | MystenLabs/solitaire@main/app/src | typescript | MystenLabs/solitaire@main | PASS | 59.7s | 2 |
| 45 | MystenLabs/walrus-sdk-relay-example-app@main/src | typescript | ...-sdk-relay-example-app@main | PASS | 16.2s | 1 |
| 46 | MystenLabs/sui-move-bootcamp@solution/I1/silver | move | .../sui-move-bootcamp@solution | PASS | 4.6s | 1 |
...
| 49 | MystenLabs/sui-stack-hello-world@main/move | unknown | .../sui-stack-hello-world@main | PASS | 4.8s | 1 |
| 50 | ...abs/sui-stack-hello-world@main/move/hello-world | move | .../sui-stack-hello-world@main | PASS | 0.6s | 1 |
| 51 | MystenLabs/sui-stack-hello-world@main/ui | typescript | .../sui-stack-hello-world@main | PASS | 11.0s | 5 |
...
| 55 | MystenLabs/plinko-poc@main/app/src | typescript | MystenLabs/plinko-poc@main | PASS | 61.8s | 1 |
| 56 | MystenLabs/plinko-poc@main/app | typescript | MystenLabs/plinko-poc@main | PASS | 18.5s | 1 |
| 57 | ...-bootcamp@solution/F1/app/my-first-sui-dapp/src | typescript | .../sui-move-bootcamp@solution | PASS | 2.7s | 2 |
| 58 | MystenLabs/sui-move-bootcamp@main/K1/contract | move | ...Labs/sui-move-bootcamp@main | PASS | 0.6s | 1 |
| 59 | MystenLabs/sui-move-bootcamp@main/K1 | typescript | ...Labs/sui-move-bootcamp@main | PASS | 6.4s | 1 |
| 60 | MystenLabs/sui-move-bootcamp@main/K1/backend | typescript | ...Labs/sui-move-bootcamp@main | PASS | 1.6s | 1 |
| 61 | ...-bootcamp@solution/C5/contracts/derived_objects | move | .../sui-move-bootcamp@solution | PASS | 0.6s | 1 |
| 62 | MystenLabs/sui-move-bootcamp@solution/C5/ts | typescript | .../sui-move-bootcamp@solution | PASS | 7.9s | 1 |
| 63 | ...sui-move-bootcamp@solution/E2/my-first-sui-dapp | typescript | .../sui-move-bootcamp@solution | PASS | 1.6s | 3 |
...
| 66 | MystenLabs/deepbookv3@main/packages/deepbook | move | MystenLabs/deepbookv3@main | PASS | 1.3s | 8 |
| 67 | ...enLabs/deepbookv3@main/packages/deepbook_margin | move | MystenLabs/deepbookv3@main | PASS | 6.1s | 7 |
| 68 | ...abs/deepbookv3@main/packages/margin_liquidation | move | MystenLabs/deepbookv3@main | PASS | 11.7s | 1 |
...
| 74 | ...eepbookv3@predict-testnet-4-16/packages/predict | move | ...bookv3@predict-testnet-4-16 | PASS | 8.8s | 8 |
...
Generated new keypair and alias for address with scheme "ed25519" [sleepy-apatite: 0x630c24e59505e6aa7c7cfaa71783a686e72a794b4f67d797d1ff89fc73ae98ac]
  secret recovery phrase : [hockey winter check thumb sudden online below antenna wrist enjoy wage enjoy]
...
- **Dependencies**: `@mysten/sui: 2.22.1`, `typescript: ^5.5.3`
- **Files**: `src/multi-recipient.ts`, `src/sponsored.ts`, `src/kiosk-borrow.ts`, `src/sponsored-kiosk.ts`, `src/coin-selection.ts`, `src/result-chaining.ts`
- **Referenced by**: [develop/transactions/ptbs/ptb-cookbook](https://docs.sui.io/develop/transactions/ptbs/ptb-cookbook) ([source](https://github.com/MystenLabs/sui/blob/main/docs/content/develop/transactions/ptbs/ptb-cookbook.mdx))
...
```
✓ Lockfile passes supply-chain policies (verified 751ms ago)
...
Done in 787ms using pnpm v11.18.0
...
Done in 1.2s using pnpm v11.18.0

```

**`pnpm run build`** — PASS (22.9s)
...
Done in 1.5s using pnpm v11.18.0
...
Done in 2.7s using pnpm v11.18.0

```

**`pnpm run build`** — PASS (67.4s)
...
.../node_modules/@tailwindcss/oxide postinstall: Done
Done in 2.1s using pnpm v11.18.0

```

**`pnpm run build`** — PASS (8.9s)
...
Done in 1.6s using pnpm v11.18.0

```

**`pnpm run build`** — PASS (6.1s)
...
Done in 2.4s using pnpm v11.18.0

```

**`pnpm run build`** — PASS (52.4s)
...
added 24 packages, and audited 25 packages in 910ms
...
- **Move edition**: 2024.beta
- **Dependencies**: `fixed_math: local`, `dusdc: local`, `account: local`, `propbook: local`, `token: local`, `pyth_lazer: f80ff8b1aa2aa9ca17530a9b6294d254f938a5bf`, `bs_oracle: 11d952488bc50f3a2526549a8cd6d4817ae20cc7`
