...
**`pnpm install`** — FAIL (9.5s)

```
? Verifying lockfile against supply-chain policies (281 entries)...
✓ Lockfile passes supply-chain policies (281 entries in 2.5s)
...
**`pnpm install`** — FAIL (1.7s)

```
✓ Lockfile passes supply-chain policies (verified 630ms ago)
...
**`pnpm install`** — FAIL (5.1s)

```
d 1, reused 0, downloaded 0, added 0
Packages: +146
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Progress: resolved 146, reused 25, downloaded 49, added 4
Progress: resolved 146, reused 25, downloaded 119, added 144
✓ Lockfile passes supply-chain policies (192 entries in 3.2s)
Progress: resolved 146, reused 25, downloaded 120, added 144
Progress: resolved 146, reused 25, downloaded 121, added 146, done
...
**`pnpm install`** — FAIL (6.0s)

```
ss: resolved 417, reused 56, downloaded 0, added 0
Progress: resolved 417, reused 89, downloaded 54, added 4
Progress: resolved 417, reused 89, downloaded 239, added 20
✓ Lockfile passes supply-chain policies (487 entries in 3.3s)
Progress: resolved 417, reused 89, downloaded 322, added 417, done
...
**`pnpm install`** — FAIL (4.7s)

```
lved 283, reused 144, downloaded 0, added 0
Progress: resolved 283, reused 245, downloaded 1, added 4
...
| 9 | examples/regulated-coin/move | move | MystenLabs/sui (internal) | PASS | 1.7s | 1 |
| 10 | examples/regulated-coin/ts-client | typescript | MystenLabs/sui (internal) | PASS | 13.2s | 1 |
| 11 | examples/move/nft-soulbound | move | MystenLabs/sui (internal) | PASS | 0.5s | 1 |
| 12 | examples/move/nft-rental | move | MystenLabs/sui (internal) | PASS | 9.7s | 1 |
...
| 15 | examples/deepbook-predict | typescript | MystenLabs/sui (internal) | PASS | 2.1s | 9 |
| 16 | examples/move/color_object | move | MystenLabs/sui (internal) | PASS | 0.5s | 1 |
| 17 | MystenLabs/sagat@main/api | typescript | MystenLabs/sagat@main | PASS | 3.1s | 4 |
| 18 | MystenLabs/sui-move-bootcamp@solution/K2/src | typescript | .../sui-move-bootcamp@solution | **FAIL** | 9.5s | 5 |
| 19 | MystenLabs/sui-move-bootcamp@solution/K2 | typescript | .../sui-move-bootcamp@solution | **FAIL** | 1.7s | 1 |
| 20 | MystenLabs/onlyfins-example-app@main/frontend | typescript | ...s/onlyfins-example-app@main | PASS | 32.5s | 1 |
| 21 | ...07-Walrus-SDK-upload-relay/hands-on-source-code | typescript | ...Labs/Walrus-Onboarding@main | PASS | 4.2s | 2 |
| 22 | MystenLabs/onlyfins-example-app@main/backend | typescript | ...s/onlyfins-example-app@main | **FAIL** | 2.4s | 3 |
| 23 | MystenLabs/walrus-pocs@main/sdk | typescript | MystenLabs/walrus-pocs@main | PASS | 4.2s | 3 |
| 24 | MystenLabs/Walrus-Onboarding@main/11-Batch-storage | typescript | ...Labs/Walrus-Onboarding@main | PASS | 4.1s | 2 |
| 25 | MystenLabs/onlyfins-example-app@main/frontend/src | typescript | ...s/onlyfins-example-app@main | PASS | 6.9s | 6 |
| 26 | MystenLabs/ts-sdks@main/packages | typescript | MystenLabs/ts-sdks@main | PASS | 14.9s | 1 |
| 27 | MystenLabs/walrus-sites@main/examples | unknown | MystenLabs/walrus-sites@main | PASS | 0.0s | 1 |
| 28 | MystenLabs/messaging-sdk-example@main/frontend/src | typescript | .../messaging-sdk-example@main | PASS | 21.8s | 1 |
| 29 | MystenLabs/onlyfins-example-app@main/frontend/move | move | ...s/onlyfins-example-app@main | PASS | 1.9s | 1 |
| 30 | ...enLabs/sui-move-bootcamp@main/K5/seal-demo/move | move | ...Labs/sui-move-bootcamp@main | PASS | 6.6s | 3 |
| 31 | MystenLabs/walrus-pocs@main/walrus-seal/app/src | typescript | MystenLabs/walrus-pocs@main | **FAIL** | 5.1s | 4 |
| 32 | MystenLabs/sui-move-bootcamp@main/K5/seal-demo/ts | typescript | ...Labs/sui-move-bootcamp@main | PASS | 3.8s | 1 |
| 33 | ...essaging@main/move/packages/sui_stack_messaging | move | ...bs/sui-stack-messaging@main | PASS | 15.1s | 3 |
| 34 | MystenLabs/sui-stack-messaging@main/chat-app/src | typescript | ...bs/sui-stack-messaging@main | **FAIL** | 6.0s | 1 |
| 35 | MystenLabs/ticketing-poc@main/move | move | MystenLabs/ticketing-poc@main | PASS | 7.1s | 3 |
| 36 | MystenLabs/ticketing-poc@main/app/src/app | typescript | MystenLabs/ticketing-poc@main | **FAIL** | 9.9s | 1 |
| 37 | MystenLabs/ticketing-poc@main/app | typescript | MystenLabs/ticketing-poc@main | **FAIL** | 2.6s | 1 |
| 38 | MystenLabs/solitaire@main/move/solitaire | move | MystenLabs/solitaire@main | PASS | 0.7s | 1 |
| 39 | MystenLabs/solitaire@main/app/src | typescript | MystenLabs/solitaire@main | PASS | 63.4s | 2 |
| 40 | MystenLabs/walrus-sdk-relay-example-app@main/src | typescript | ...-sdk-relay-example-app@main | **FAIL** | 6.7s | 1 |
| 41 | MystenLabs/sui-move-bootcamp@solution/I1/silver | move | .../sui-move-bootcamp@solution | PASS | 6.2s | 1 |
| 42 | ...Labs/sui-move-bootcamp@solution/I3/king_credits | move | .../sui-move-bootcamp@solution | PASS | 0.7s | 2 |
| 43 | ...Labs/sui-move-bootcamp@solution/I2/fixed_supply | move | .../sui-move-bootcamp@solution | PASS | 0.6s | 1 |
| 44 | MystenLabs/sui-stack-hello-world@main/move | unknown | .../sui-stack-hello-world@main | PASS | 6.4s | 1 |
| 45 | ...abs/sui-stack-hello-world@main/move/hello-world | move | .../sui-stack-hello-world@main | PASS | 0.7s | 1 |
| 46 | MystenLabs/sui-stack-hello-world@main/ui | typescript | .../sui-stack-hello-world@main | **FAIL** | 4.7s | 5 |
...
| 50 | MystenLabs/plinko-poc@main/app/src | typescript | MystenLabs/plinko-poc@main | **FAIL** | 9.0s | 1 |
| 51 | MystenLabs/plinko-poc@main/app | typescript | MystenLabs/plinko-poc@main | **FAIL** | 2.6s | 1 |
| 52 | ...-bootcamp@solution/F1/app/my-first-sui-dapp/src | typescript | .../sui-move-bootcamp@solution | PASS | 2.4s | 2 |
| 53 | MystenLabs/CTF@main/contracts | move | MystenLabs/CTF@main | **FAIL** | 1.6s | 1 |
| 54 | MystenLabs/sui-move-bootcamp@main/K1/contract | move | ...Labs/sui-move-bootcamp@main | PASS | 0.7s | 1 |
| 55 | MystenLabs/sui-move-bootcamp@main/K1 | typescript | ...Labs/sui-move-bootcamp@main | PASS | 6.5s | 1 |
...
| 58 | MystenLabs/sui-move-bootcamp@solution/C5/ts | typescript | .../sui-move-bootcamp@solution | **FAIL** | 8.3s | 1 |
| 59 | ...sui-move-bootcamp@solution/E2/my-first-sui-dapp | typescript | .../sui-move-bootcamp@solution | PASS | 1.4s | 3 |
| 60 | ...move-bootcamp@solution/E2/my-first-sui-dapp/src | typescript | .../sui-move-bootcamp@solution | PASS | 1.4s | 1 |
...
| 67 | MystenLabs/deepbookv3@main/packages/deepbook | move | MystenLabs/deepbookv3@main | PASS | 3.0s | 7 |
| 68 | ...eepbookv3@predict-testnet-4-16/packages/predict | move | ...bookv3@predict-testnet-4-16 | PASS | 13.0s | 8 |
| 69 | ...enLabs/deepbookv3@main/packages/deepbook_margin | move | MystenLabs/deepbookv3@main | PASS | 16.8s | 6 |
...
Generated new keypair and alias for address with scheme "ed25519" [quizzical-chrysoprase: 0xbf0865b6b259a39c386e086879907363e69bafbb30c3318dcc7a6af43d869b83]
  secret recovery phrase : [draw broken hard west wedding lens pond drift actor outdoor early lizard]
...
Done in 13.5s using pnpm v10.33.0
...
**`npm install`** — PASS (14.2s)

```

added 419 packages, and audited 420 packages in 14s
...
```
 resolved 146, reused 25, downloaded 119, added 144
✓ Lockfile passes supply-chain policies (192 entries in 3.2s)
Progress: resolved 146, reused 25, downloaded 120, added 144
Progress: resolved 146, reused 25, downloaded 121, added 146, done
...
Done in 8.4s using pnpm v10.10.0

```

**`pnpm run build`** — PASS (53.7s)
...
added 24 packages, and audited 25 packages in 858ms
