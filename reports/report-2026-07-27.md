...
```
✓ Lockfile passes supply-chain policies (verified 534ms ago)
[ERR_PNPM_OUTDATED_LOCKFILE] Cannot install with "frozen-lockfile" because pnpm-lock.yaml is not up to date with <ROOT>/package.json
...
**`pnpm install`** — FAIL (2.3s)

```
[reinstall after approve-builds also failed]
[WARN] The "pnpm" field in package.json is no longer read by pnpm. The following keys were ignored: "pnpm.onlyBuiltDependencies". See https://pnpm.io/settings for the new home of each setting.

✓ Lockfile passes supply-chain policies (verified 566ms ago)
...
| 7 | examples/move/nft-soulbound | move | MystenLabs/sui (internal) | PASS | 0.5s | 1 |
| 8 | examples/move/nft-rental | move | MystenLabs/sui (internal) | PASS | 10.3s | 1 |
| 9 | examples/move/token | move | MystenLabs/sui (internal) | PASS | 0.5s | 1 |
| 10 | examples/vesting | move | MystenLabs/sui (internal) | PASS | 0.5s | 6 |
| 11 | examples/move/coin | move | MystenLabs/sui (internal) | PASS | 0.5s | 3 |
| 12 | examples/regulated-coin/move | move | MystenLabs/sui (internal) | PASS | 0.4s | 1 |
| 13 | examples/regulated-coin/ts-client | typescript | MystenLabs/sui (internal) | PASS | 11.8s | 1 |
...
| 17 | examples/deepbook-predict | typescript | MystenLabs/sui (internal) | PASS | 2.0s | 9 |
...
| 22 | MystenLabs/onlyfins-example-app@main/frontend | typescript | ...s/onlyfins-example-app@main | PASS | 31.8s | 1 |
| 23 | ...07-Walrus-SDK-upload-relay/hands-on-source-code | typescript | ...Labs/Walrus-Onboarding@main | PASS | 3.7s | 2 |
| 24 | MystenLabs/onlyfins-example-app@main/backend | typescript | ...s/onlyfins-example-app@main | **FAIL** | 2.3s | 3 |
| 25 | MystenLabs/walrus-pocs@main/sdk | typescript | MystenLabs/walrus-pocs@main | PASS | 4.0s | 3 |
| 26 | MystenLabs/Walrus-Onboarding@main/11-Batch-storage | typescript | ...Labs/Walrus-Onboarding@main | PASS | 3.6s | 2 |
| 27 | MystenLabs/onlyfins-example-app@main/frontend/src | typescript | ...s/onlyfins-example-app@main | PASS | 6.5s | 6 |
| 28 | MystenLabs/ts-sdks@main/packages | typescript | MystenLabs/ts-sdks@main | PASS | 13.8s | 1 |
| 29 | MystenLabs/walrus-sites@main/examples | unknown | MystenLabs/walrus-sites@main | PASS | 0.0s | 1 |
| 30 | MystenLabs/messaging-sdk-example@main/frontend/src | typescript | .../messaging-sdk-example@main | PASS | 19.3s | 1 |
| 31 | MystenLabs/onlyfins-example-app@main/frontend/move | move | ...s/onlyfins-example-app@main | PASS | 1.3s | 1 |
| 32 | ...enLabs/sui-move-bootcamp@main/K5/seal-demo/move | move | ...Labs/sui-move-bootcamp@main | PASS | 4.8s | 3 |
| 33 | MystenLabs/walrus-pocs@main/walrus-seal/app/src | typescript | MystenLabs/walrus-pocs@main | **FAIL** | 5.0s | 4 |
| 34 | MystenLabs/sui-move-bootcamp@main/K5/seal-demo/ts | typescript | ...Labs/sui-move-bootcamp@main | PASS | 3.4s | 1 |
| 35 | ...essaging@main/move/packages/sui_stack_messaging | move | ...bs/sui-stack-messaging@main | PASS | 10.6s | 3 |
| 36 | MystenLabs/sui-stack-messaging@main/chat-app/src | typescript | ...bs/sui-stack-messaging@main | **FAIL** | 5.9s | 1 |
| 37 | MystenLabs/ticketing-poc@main/move | move | MystenLabs/ticketing-poc@main | PASS | 5.4s | 3 |
| 38 | MystenLabs/ticketing-poc@main/app/src/app | typescript | MystenLabs/ticketing-poc@main | **FAIL** | 9.8s | 1 |
| 39 | MystenLabs/ticketing-poc@main/app | typescript | MystenLabs/ticketing-poc@main | **FAIL** | 2.3s | 1 |
| 40 | MystenLabs/solitaire@main/move/solitaire | move | MystenLabs/solitaire@main | PASS | 0.6s | 1 |
| 41 | MystenLabs/solitaire@main/app/src | typescript | MystenLabs/solitaire@main | PASS | 53.7s | 2 |
| 42 | MystenLabs/walrus-sdk-relay-example-app@main/src | typescript | ...-sdk-relay-example-app@main | **FAIL** | 6.6s | 1 |
| 43 | ...Labs/sui-move-bootcamp@solution/I3/king_credits | move | .../sui-move-bootcamp@solution | PASS | 4.6s | 2 |
| 44 | ...Labs/sui-move-bootcamp@solution/I2/fixed_supply | move | .../sui-move-bootcamp@solution | PASS | 0.6s | 1 |
| 45 | MystenLabs/sui-move-bootcamp@solution/I1/silver | move | .../sui-move-bootcamp@solution | PASS | 0.6s | 1 |
| 46 | MystenLabs/sui-stack-hello-world@main/move | unknown | .../sui-stack-hello-world@main | PASS | 4.8s | 1 |
| 47 | ...abs/sui-stack-hello-world@main/move/hello-world | move | .../sui-stack-hello-world@main | PASS | 0.6s | 1 |
| 48 | MystenLabs/sui-stack-hello-world@main/ui | typescript | .../sui-stack-hello-world@main | **FAIL** | 4.9s | 5 |
...
| 52 | MystenLabs/plinko-poc@main/app/src | typescript | MystenLabs/plinko-poc@main | **FAIL** | 8.4s | 1 |
| 53 | MystenLabs/plinko-poc@main/app | typescript | MystenLabs/plinko-poc@main | **FAIL** | 2.3s | 1 |
...
| 59 | MystenLabs/sui-move-bootcamp@solution/C5/ts | typescript | .../sui-move-bootcamp@solution | **FAIL** | 8.3s | 1 |
...
| 63 | MystenLabs/deepbookv3@main/packages/deepbook | move | MystenLabs/deepbookv3@main | PASS | 1.4s | 8 |
| 64 | ...enLabs/deepbookv3@main/packages/deepbook_margin | move | MystenLabs/deepbookv3@main | PASS | 10.6s | 7 |
| 65 | ...abs/deepbookv3@main/packages/margin_liquidation | move | MystenLabs/deepbookv3@main | PASS | 11.1s | 1 |
...
| 71 | ...eepbookv3@predict-testnet-4-16/packages/predict | move | ...bookv3@predict-testnet-4-16 | PASS | 9.0s | 8 |
...
Generated new keypair and alias for address with scheme "ed25519" [vigilant-coral: 0xa71eea71c97cc91d001ae1cb027dc6757dcf689739ea3fd05aa597d511d4fb66]
  secret recovery phrase : [forget legal cotton embark mixture close great spice evil three knock lobster]
...
Done in 6s using pnpm v10.10.0

```

**`pnpm run build`** — PASS (46.4s)
...
added 24 packages, and audited 25 packages in 786ms
