...
```
✓ Lockfile passes supply-chain policies (verified 548ms ago)
[ERR_PNPM_OUTDATED_LOCKFILE] Cannot install with "frozen-lockfile" because pnpm-lock.yaml is not up to date with <ROOT>/package.json
...
| 2 | examples/move/dynamic_fields | move | MystenLabs/sui (internal) | PASS | 0.4s | 1 |
...
| 10 | examples/regulated-coin/ts-client | typescript | MystenLabs/sui (internal) | **FAIL** | 12.1s | 1 |
| 11 | examples/move/nft-soulbound | move | MystenLabs/sui (internal) | PASS | 0.4s | 1 |
| 12 | examples/move/nft-rental | move | MystenLabs/sui (internal) | PASS | 5.9s | 1 |
...
| 19 | MystenLabs/sagat@main/api | typescript | MystenLabs/sagat@main | PASS | 3.1s | 4 |
...
| 22 | MystenLabs/onlyfins-example-app@main/frontend | typescript | ...s/onlyfins-example-app@main | PASS | 34.8s | 1 |
| 23 | ...07-Walrus-SDK-upload-relay/hands-on-source-code | typescript | ...Labs/Walrus-Onboarding@main | PASS | 4.0s | 2 |
| 24 | MystenLabs/onlyfins-example-app@main/backend | typescript | ...s/onlyfins-example-app@main | PASS | 4.3s | 3 |
| 25 | MystenLabs/walrus-pocs@main/sdk | typescript | MystenLabs/walrus-pocs@main | PASS | 4.2s | 3 |
| 26 | MystenLabs/Walrus-Onboarding@main/11-Batch-storage | typescript | ...Labs/Walrus-Onboarding@main | PASS | 4.0s | 2 |
| 27 | MystenLabs/onlyfins-example-app@main/frontend/src | typescript | ...s/onlyfins-example-app@main | PASS | 6.9s | 6 |
| 28 | MystenLabs/ts-sdks@main/packages | typescript | MystenLabs/ts-sdks@main | PASS | 14.9s | 1 |
| 29 | MystenLabs/walrus-sites@main/examples | unknown | MystenLabs/walrus-sites@main | PASS | 0.0s | 1 |
| 30 | MystenLabs/messaging-sdk-example@main/frontend/src | typescript | .../messaging-sdk-example@main | PASS | 20.8s | 1 |
| 31 | MystenLabs/onlyfins-example-app@main/frontend/move | move | ...s/onlyfins-example-app@main | PASS | 1.1s | 1 |
| 32 | ...enLabs/sui-move-bootcamp@main/K5/seal-demo/move | move | ...Labs/sui-move-bootcamp@main | PASS | 4.9s | 3 |
| 33 | MystenLabs/walrus-pocs@main/walrus-seal/app/src | typescript | MystenLabs/walrus-pocs@main | PASS | 28.9s | 4 |
...
| 36 | MystenLabs/sui-stack-messaging@main/chat-app/src | typescript | ...bs/sui-stack-messaging@main | PASS | 14.1s | 1 |
| 37 | MystenLabs/ticketing-poc@main/move | move | MystenLabs/ticketing-poc@main | PASS | 5.3s | 3 |
| 38 | MystenLabs/ticketing-poc@main/app/src/app | typescript | MystenLabs/ticketing-poc@main | PASS | 80.3s | 1 |
| 39 | MystenLabs/ticketing-poc@main/app | typescript | MystenLabs/ticketing-poc@main | PASS | 42.7s | 1 |
| 40 | MystenLabs/solitaire@main/move/solitaire | move | MystenLabs/solitaire@main | PASS | 0.7s | 1 |
| 41 | MystenLabs/solitaire@main/app/src | typescript | MystenLabs/solitaire@main | PASS | 59.3s | 2 |
| 42 | MystenLabs/walrus-sdk-relay-example-app@main/src | typescript | ...-sdk-relay-example-app@main | PASS | 16.9s | 1 |
| 43 | MystenLabs/sui-move-bootcamp@solution/I1/silver | move | .../sui-move-bootcamp@solution | PASS | 4.6s | 1 |
| 44 | ...Labs/sui-move-bootcamp@solution/I3/king_credits | move | .../sui-move-bootcamp@solution | PASS | 0.6s | 2 |
| 45 | ...Labs/sui-move-bootcamp@solution/I2/fixed_supply | move | .../sui-move-bootcamp@solution | PASS | 0.7s | 1 |
...
| 48 | MystenLabs/sui-stack-hello-world@main/ui | typescript | .../sui-stack-hello-world@main | PASS | 11.8s | 5 |
...
| 52 | MystenLabs/plinko-poc@main/app/src | typescript | MystenLabs/plinko-poc@main | PASS | 64.3s | 1 |
| 53 | MystenLabs/plinko-poc@main/app | typescript | MystenLabs/plinko-poc@main | PASS | 31.2s | 1 |
| 54 | ...-bootcamp@solution/F1/app/my-first-sui-dapp/src | typescript | .../sui-move-bootcamp@solution | PASS | 2.5s | 2 |
| 55 | MystenLabs/sui-move-bootcamp@main/K1/contract | move | ...Labs/sui-move-bootcamp@main | PASS | 0.8s | 1 |
| 56 | MystenLabs/sui-move-bootcamp@main/K1 | typescript | ...Labs/sui-move-bootcamp@main | PASS | 6.3s | 1 |
...
| 59 | MystenLabs/sui-move-bootcamp@solution/C5/ts | typescript | .../sui-move-bootcamp@solution | PASS | 8.7s | 1 |
...
| 64 | ...enLabs/deepbookv3@main/packages/deepbook_margin | move | MystenLabs/deepbookv3@main | PASS | 12.2s | 7 |
| 65 | ...abs/deepbookv3@main/packages/margin_liquidation | move | MystenLabs/deepbookv3@main | PASS | 9.0s | 1 |
...
| 71 | ...eepbookv3@predict-testnet-4-16/packages/predict | move | ...bookv3@predict-testnet-4-16 | PASS | 7.5s | 8 |
...
Generated new keypair and alias for address with scheme "ed25519" [suspicious-avanturine: 0xd29bd5e2274b3f5db801b9f1f3db8bdd8a4a3ec318ccede548ea739086415cb8]
  secret recovery phrase : [potato curtain story fruit spike alter effort exit valve sauce answer build]
...
**`pnpm install`** — PASS (2.5s)

```
✓ Lockfile passes supply-chain policies (verified 600ms ago)
...
Done in 1.1s using pnpm v11.17.0

```

**`pnpm run build`** — PASS (23.4s)
...
Done in 6.2s using pnpm v10.10.0

```

**`pnpm run build`** — PASS (51.8s)
...
Done in 1.6s using pnpm v11.17.0
...
added 24 packages, and audited 25 packages in 849ms
