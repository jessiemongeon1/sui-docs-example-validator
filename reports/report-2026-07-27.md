...
**`pnpm install`** — FAIL (3.2s)

```
? Verifying lockfile against supply-chain policies (281 entries)...
✓ Lockfile passes supply-chain policies (281 entries in 2.6s)
...
```
✓ Lockfile passes supply-chain policies (verified 587ms ago)
[ERR_PNPM_OUTDATED_LOCKFILE] Cannot install with "frozen-lockfile" because pnpm-lock.yaml is not up to date with <ROOT>/package.json
...
### MystenLabs/onlyfins-example-app@main/frontend
...
npm error A complete log of this run can be found in: /home/runner/.npm/_logs/2026-07-27T19_38_25_021Z-debug-0.log
```

---

### MystenLabs/onlyfins-example-app@main/frontend/src
...
npm error
npm error Run "npm help ci" for more info
npm error A complete log of this run can be found in: /home/runner/.npm/_logs/2026-07-27T19_38_42_984Z-debug-0.log
```

---

### MystenLabs/messaging-sdk-example@main/frontend/src

- **Failure**: Dependency installation failed
- **Type**: typescript | **Origin**: MystenLabs/messaging-sdk-example@main
...
- **Docs pages**: [sui-stack/suins/sui-stack-suins](https://docs.sui.io/sui-stack/suins/sui-stack-suins) ([source](https://github.com/MystenLabs/sui/blob/main/docs/content/sui-stack/suins/sui-stack-suins.mdx))
...
npm error
npm error Run "npm help ci" for more info
npm error A complete log of this run can be found in: /home/runner/.npm/_logs/2026-07-27T19_41_56_545Z-debug-0.log
```
...
npm error
npm error Run "npm help ci" for more info
npm error A complete log of this run can be found in: /home/runner/.npm/_logs/2026-07-27T19_44_54_993Z-debug-0.log
```
...
| 6 | examples/move/hero | move | MystenLabs/sui (internal) | PASS | 0.6s | 1 |
| 7 | examples/vesting | move | MystenLabs/sui (internal) | PASS | 0.6s | 6 |
| 8 | examples/move/coin | move | MystenLabs/sui (internal) | PASS | 0.7s | 3 |
| 9 | examples/regulated-coin/move | move | MystenLabs/sui (internal) | PASS | 0.6s | 1 |
| 10 | examples/regulated-coin/ts-client | typescript | MystenLabs/sui (internal) | PASS | 15.2s | 1 |
| 11 | examples/move/nft-soulbound | move | MystenLabs/sui (internal) | PASS | 0.5s | 1 |
| 12 | examples/move/nft-rental | move | MystenLabs/sui (internal) | PASS | 9.2s | 1 |
...
| 19 | MystenLabs/sagat@main/api | typescript | MystenLabs/sagat@main | PASS | 4.9s | 4 |
| 20 | MystenLabs/sui-move-bootcamp@solution/K2/src | typescript | .../sui-move-bootcamp@solution | **FAIL** | 3.2s | 5 |
| 21 | MystenLabs/sui-move-bootcamp@solution/K2 | typescript | .../sui-move-bootcamp@solution | **FAIL** | 0.5s | 1 |
| 22 | MystenLabs/onlyfins-example-app@main/frontend | typescript | ...s/onlyfins-example-app@main | **FAIL** | 0.3s | 1 |
| 23 | ...07-Walrus-SDK-upload-relay/hands-on-source-code | typescript | ...Labs/Walrus-Onboarding@main | PASS | 4.5s | 2 |
| 24 | MystenLabs/onlyfins-example-app@main/backend | typescript | ...s/onlyfins-example-app@main | PASS | 3.7s | 3 |
...
| 27 | MystenLabs/onlyfins-example-app@main/frontend/src | typescript | ...s/onlyfins-example-app@main | **FAIL** | 0.3s | 6 |
| 28 | MystenLabs/ts-sdks@main/packages | typescript | MystenLabs/ts-sdks@main | PASS | 15.1s | 1 |
| 29 | MystenLabs/walrus-sites@main/examples | unknown | MystenLabs/walrus-sites@main | PASS | 0.0s | 1 |
| 30 | MystenLabs/messaging-sdk-example@main/frontend/src | typescript | .../messaging-sdk-example@main | **FAIL** | 0.3s | 1 |
| 31 | MystenLabs/onlyfins-example-app@main/frontend/move | move | ...s/onlyfins-example-app@main | PASS | 1.8s | 1 |
| 32 | ...enLabs/sui-move-bootcamp@main/K5/seal-demo/move | move | ...Labs/sui-move-bootcamp@main | PASS | 6.3s | 3 |
| 33 | MystenLabs/walrus-pocs@main/walrus-seal/app/src | typescript | MystenLabs/walrus-pocs@main | **FAIL** | 5.5s | 4 |
...
| 36 | MystenLabs/sui-stack-messaging@main/chat-app/src | typescript | ...bs/sui-stack-messaging@main | **FAIL** | 6.5s | 1 |
| 37 | MystenLabs/ticketing-poc@main/move | move | MystenLabs/ticketing-poc@main | PASS | 7.8s | 3 |
| 38 | MystenLabs/ticketing-poc@main/app/src/app | typescript | MystenLabs/ticketing-poc@main | **FAIL** | 10.1s | 1 |
| 39 | MystenLabs/ticketing-poc@main/app | typescript | MystenLabs/ticketing-poc@main | **FAIL** | 1.8s | 1 |
| 40 | MystenLabs/solitaire@main/move/solitaire | move | MystenLabs/solitaire@main | PASS | 0.8s | 1 |
| 41 | MystenLabs/solitaire@main/app/src | typescript | MystenLabs/solitaire@main | PASS | 62.2s | 2 |
| 42 | MystenLabs/walrus-sdk-relay-example-app@main/src | typescript | ...-sdk-relay-example-app@main | **FAIL** | 7.4s | 1 |
| 43 | MystenLabs/sui-stack-hello-world@main/move | unknown | .../sui-stack-hello-world@main | PASS | 7.5s | 1 |
| 44 | ...abs/sui-stack-hello-world@main/move/hello-world | move | .../sui-stack-hello-world@main | PASS | 0.7s | 1 |
| 45 | MystenLabs/sui-stack-hello-world@main/ui | typescript | .../sui-stack-hello-world@main | **FAIL** | 5.1s | 5 |
| 46 | MystenLabs/sui-move-bootcamp@solution/G1/scenario | move | .../sui-move-bootcamp@solution | PASS | 6.5s | 2 |
| 47 | MystenLabs/sui-move-bootcamp@solution/G1 | move | .../sui-move-bootcamp@solution | PASS | 0.7s | 2 |
| 48 | MystenLabs/plinko-poc@main/plinko | move | MystenLabs/plinko-poc@main | PASS | 0.7s | 2 |
| 49 | MystenLabs/plinko-poc@main/app/src | typescript | MystenLabs/plinko-poc@main | **FAIL** | 9.6s | 1 |
| 50 | MystenLabs/plinko-poc@main/app | typescript | MystenLabs/plinko-poc@main | **FAIL** | 1.8s | 1 |
| 51 | ...-bootcamp@solution/F1/app/my-first-sui-dapp/src | typescript | .../sui-move-bootcamp@solution | PASS | 2.5s | 2 |
| 52 | MystenLabs/sui-move-bootcamp@main/K1/contract | move | ...Labs/sui-move-bootcamp@main | PASS | 0.7s | 1 |
| 53 | MystenLabs/sui-move-bootcamp@main/K1 | typescript | ...Labs/sui-move-bootcamp@main | PASS | 6.6s | 1 |
| 54 | MystenLabs/sui-move-bootcamp@main/K1/backend | typescript | ...Labs/sui-move-bootcamp@main | PASS | 1.6s | 1 |
| 55 | ...-bootcamp@solution/C5/contracts/derived_objects | move | .../sui-move-bootcamp@solution | PASS | 0.7s | 1 |
| 56 | MystenLabs/sui-move-bootcamp@solution/C5/ts | typescript | .../sui-move-bootcamp@solution | **FAIL** | 0.3s | 1 |
| 57 | ...sui-move-bootcamp@solution/E2/my-first-sui-dapp | typescript | .../sui-move-bootcamp@solution | PASS | 1.4s | 3 |
| 58 | ...move-bootcamp@solution/E2/my-first-sui-dapp/src | typescript | .../sui-move-bootcamp@solution | PASS | 1.4s | 1 |
| 59 | MystenLabs/sui-move-bootcamp@solution/I1/silver | move | .../sui-move-bootcamp@solution | PASS | 0.7s | 1 |
| 60 | ...Labs/sui-move-bootcamp@solution/I3/king_credits | move | .../sui-move-bootcamp@solution | PASS | 0.7s | 2 |
| 61 | ...Labs/sui-move-bootcamp@solution/I2/fixed_supply | move | .../sui-move-bootcamp@solution | PASS | 0.6s | 1 |
| 62 | MystenLabs/ts-sdks@main/packages/deepbook-v3 | typescript | MystenLabs/ts-sdks@main | PASS | 0.0s | 8 |
| 63 | MystenLabs/deepbookv3@main/packages/deepbook | move | MystenLabs/deepbookv3@main | PASS | 2.4s | 8 |
| 64 | ...enLabs/deepbookv3@main/packages/deepbook_margin | move | MystenLabs/deepbookv3@main | PASS | 16.9s | 7 |
| 65 | ...abs/deepbookv3@main/packages/margin_liquidation | move | MystenLabs/deepbookv3@main | PASS | 18.5s | 1 |
...
| 71 | ...eepbookv3@predict-testnet-4-16/packages/predict | move | ...bookv3@predict-testnet-4-16 | PASS | 12.5s | 8 |
...
Generated new keypair and alias for address with scheme "ed25519" [funny-corundum: 0x2e325c67507881ba7e767c8d44bc5594c8e1160992da0400220b810a5c0b03d0]
  secret recovery phrase : [lyrics garden orange coyote winter suggest hurdle number exchange adapt theory parrot]
...
<details><summary>FAIL — MystenLabs/onlyfins-example-app@main/frontend (typescript)</summary>
...
<details><summary>FAIL — MystenLabs/onlyfins-example-app@main/frontend/src (typescript)</summary>
...
Done in 13.8s using pnpm v10.33.0
...
<details><summary>FAIL — MystenLabs/messaging-sdk-example@main/frontend/src (typescript)</summary>
...
**`pnpm install`** — PASS (4.1s)

```
 resolved 146, reused 11, downloaded 132, added 137
✓ Lockfile passes supply-chain policies (192 entries in 2.9s)
Progress: resolved 146, reused 11, downloaded 134, added 145
...
**`pnpm install`** — PASS (5.1s)

```
 33, downloaded 378, added 413
...
added 24 packages, and audited 25 packages in 859ms
